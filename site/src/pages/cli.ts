...
export function CliPage() {
  return createElement(
    ...
    createElement(
      ...
      createElement("p", null, "The jsonlint command-line tool validates, formats, and optionally transforms JSON files."),
...
bad.json: line 2, col 5, found: '}' - expected: 'STRING'.`,
      ...
      createElement(
        "pre",
        null,
        createElement("code", null, 'echo \'{"key": "value"}\' | jsonlint -q'),
      ),
    ),
  );
}
