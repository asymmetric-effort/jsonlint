  ...
  return createElement(
    ...
    createElement(
      ...
      createElement(
        "pre",
        null,
        createElement("code", null, "npm install -g @asymmetric-effort/jsonlint"),
      ),
    ),
    createElement(
      "div",
    ...
    createElement(
      ...
      createElement(
        ...
        createElement(
          "thead",
          null,
          createElement("tr", null, createElement("th", null, "Feature"), createElement("th", null, "Description")),
        ),
        createElement(
          "tbody",
          null,
          ...features.map(([f, d]) =>
            createElement(
              "tr",
              { key: f },
              createElement("td", null, createElement("strong", null, f)),
              createElement("td", null, d),
            ),
          ),
        ),
      ),
